...
<script lang="ts">
    ...
    import type { ModalPopupEntry } from "$lib/util.js";
    ...
    let changePasswordEntries: ModalPopupEntry[] = $derived([
        { type: "warning", value: "Login successful, temporary password must be changed." },
        ...
        { type: "entry", title: "User: ", value: data.user.username },
...
<ModalPopup
    ...
    useFormEnhance={true}
    openAndPermanent={true}
    hasExtraLinkButton={true}
    linkButtonLink={"/logout"}
    linkButtonText={"Logout"}
